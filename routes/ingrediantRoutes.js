...
router.post("/", roleAuth(["admin","manager"]), createIngredient);
...
router.get("/", roleAuth(["admin","manager"]),getAllIngrediants);
// router.get("/ingrediants", getAllIngrediantsByType);
// router.get("/prod/:productId", getIngrediantByProduct);
router.put("/update/:ingrediantId", roleAuth(["admin","manager"]), updateIngrediant);
router.delete("/:ingrediantId", roleAuth(["admin","manager"]), deleteIngredient);
