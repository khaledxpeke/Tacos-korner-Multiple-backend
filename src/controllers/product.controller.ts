...
const getFinalPrice = (product: DiscountableProduct, useFormulePrice = false): DiscountInfo => {
...
const calculateDiscountInfo = (product: DiscountableProduct): DiscountInfo => {
...
const addTimezoneZ = (dateString: string | null | undefined): string | null => {
